...
from main.views import first_page, create_item_entry, show_xml, show_json, show_xml_by_id, show_json_by_id, login_user, logout_user, register, edit_item, delete_item, add_item_entry_ajax
